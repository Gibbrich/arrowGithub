...
import com.github.gibbrich.arrowgithub.BuildConfig
...
private fun createRetrofit(application: Application) : Retrofit {
    ...
    val httpClient = provideOkHttpClientOAuth(cache)
    return getRetrofitBuilderDefaults().client(httpClient).build()
}
